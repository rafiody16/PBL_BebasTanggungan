                ...
                <div class="card-body">
                  <div class="" style="padding: 20px; border-radius: 100px;">
                    ...
                    <p>Selamat datang di beranda Sistem Informasi Bebas Tanggungan Jurusan Teknologi Informasi (BeTaTI). 
                        Ini adalah tempat di mana Anda dapat mengakses semua informasi penting yang berkaitan dengan pengurusan bebas tanggungan mahasiswa Jurusan Teknologi Informasi Politeknik Negeri Malang.</p>
                  </div>
                </div>
              </div>
          </div>
