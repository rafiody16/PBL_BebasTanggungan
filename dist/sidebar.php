            ...
            <ul class="menu">
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  ...
                  <li class="submenu-item">
                    <a href="component-placeholder.html" class="submenu-link"
                      >Placeholder</a
                    >
                  </li>
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  ...
                  <li class="submenu-item">
                    <a href="ui-map-leaflet.html" class="submenu-link"
                      >Leaflet Map</a
                    >
                  </li>

                  <li class="submenu-item">
                    <a href="ui-map-openlayers.html" class="submenu-link"
                      >OpenLayers Map</a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item">
                <a
                  href="https://github.com/sponsors/zuramai"
                  class="sidebar-link"
                >
