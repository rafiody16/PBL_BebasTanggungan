            ...
            <div class="card">
                <div class="card-body">
                  <div class="" style="padding: 20px; border-radius: 100px;">
                    <h5>Halo, verifikator Berkas Tugas Akhir!</h5>
                    <p>Selamat datang di beranda Sistem Informasi Bebas Tanggungan Jurusan Teknologi Informasi (BeTaTI). 
                    Ini adalah tempat di mana Anda dapat mengakses semua informasi penting yang berkaitan dengan verifikasi berkas tugas akhir untuk pengurusan bebas tanggungan mahasiswa Jurusan Teknologi Informasi Politeknik Negeri Malang.</p>
                  </div>
                </div>
              </div>
          </div>
